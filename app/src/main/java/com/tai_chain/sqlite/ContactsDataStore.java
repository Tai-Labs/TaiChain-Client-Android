...
public class ContactsDataStore implements DataSourceInterface {
    private SQLiteDatabase database;
    private final BRSQLiteHelper dbHelper;
    private static ContactsDataStore instance;
    ...
    private ContactsDataStore(Context context) {
        dbHelper = BRSQLiteHelper.getInstance(context);
    }

    public static ContactsDataStore getInstance(Context context) {
        if (instance == null) {
            instance = new ContactsDataStore(context);
        }
        return instance;
    }
